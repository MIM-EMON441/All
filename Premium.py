...
def banner_logo():
    ...
    Console(style="bold blue").print(Panel(f"""[bold green]   _____  _____  ______ __  __ _____ _    _ __  __ 
[bold green]  |  __ \|  __ \|  ____|  \/  |_   _| |  | |  \/  |
[bold green]  | |__) | |__) | |__  | \  / | | | | |  | | \  / |
[bold green]  |  ___/|  _  /|  __| | |\/| | | | | |  | | |\/| |
[bold green]  | |    | | \ \| |____| |  | |_| |_| |__| | |  | |
[bold green]  |_|    |_|  \_\______|_|  |_|_____|\____/|_|  |_|
\t   [bold white]reversed by [bold red]exotic-hridoy""",  style="bold blue"))
...
[bold white]User :[bold yellow] {id}""", title="[bold blue] (Welcome) [bold yellow]"))
            ...
            try:
                Console().print("[bold blue]   ╰─>[bold green] You Will Be Redirected To Admin Instagram ", end='\r');time.sleep(3.6);os.system("xdg-open https://instagram.com/reverse_exec/");exit()
            except:exit()
...
if __name__ == '__main__':
    try:
        os.system('mkdir Data');daftar_menu()
    except Exception as e:
        Console(width=60, style="bold blue").print(Panel(f"[bold red]{str(e).title()}", title="[bold red] (Error) "));exit()
